package com.droidupps.myapplication.Transitions;
...
public class DetailsTransition extends TransitionSet {
    ...
    private void init() {
        setOrdering(ORDERING_TOGETHER).setDuration(2000);
        addTransition(new ChangeBounds().setDuration(2000)).
                addTransition(new ChangeTransform().setDuration(2000)).
                addTransition(new ChangeImageTransform().setDuration(2000));
    }
}
